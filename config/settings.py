...
INSTALLED_APPS=['django.contrib.admin','django.contrib.auth','django.contrib.contenttypes','django.contrib.sessions','django.contrib.messages','django.contrib.staticfiles','django_otp','django_otp.plugins.otp_totp','axes','vault.apps.VaultConfig','soat.apps.SoatConfig','conciliacion.apps.ConciliacionConfig','integrations.apps.IntegrationsConfig','cotizacion_colectivos.apps.CotizacionColectivosConfig','intranet_sso.apps.IntranetSsoConfig','asistente_zoho.apps.AsistenteZohoConfig']
...
COLECTIVOS_EXTERNAL_LINK_DAYS=email_env_int('COLECTIVOS_EXTERNAL_LINK_DAYS',2,1,30)
COLECTIVOS_EXTERNAL_LINK_MAX_DAYS=email_env_int('COLECTIVOS_EXTERNAL_LINK_MAX_DAYS',30,1,90)
COLECTIVOS_TASK_PUBLISH_ENABLED=env_bool('COLECTIVOS_TASK_PUBLISH_ENABLED',False)
COLECTIVOS_TASK_WRITE_CONFIRMATION=os.getenv('COLECTIVOS_TASK_WRITE_CONFIRMATION','').strip()
COLECTIVOS_CONTACT_PUBLISH_ENABLED=env_bool('COLECTIVOS_CONTACT_PUBLISH_ENABLED',False)
COLECTIVOS_CONTACT_WRITE_CONFIRMATION=os.getenv('COLECTIVOS_CONTACT_WRITE_CONFIRMATION','').strip()
COLECTIVOS_SANDBOX_TASK_WRITE_CONFIRMATION=os.getenv('COLECTIVOS_SANDBOX_TASK_WRITE_CONFIRMATION','').strip()
COLECTIVOS_PRODUCTION_TASK_WRITE_CONFIRMATION=os.getenv('COLECTIVOS_PRODUCTION_TASK_WRITE_CONFIRMATION','').strip()
COLECTIVOS_SANDBOX_CONTACT_WRITE_CONFIRMATION=os.getenv('COLECTIVOS_SANDBOX_CONTACT_WRITE_CONFIRMATION','').strip()
COLECTIVOS_PRODUCTION_CONTACT_WRITE_CONFIRMATION=os.getenv('COLECTIVOS_PRODUCTION_CONTACT_WRITE_CONFIRMATION','').strip()
COLECTIVOS_SANDBOX_RISK_WRITE_CONFIRMATION=os.getenv('COLECTIVOS_SANDBOX_RISK_WRITE_CONFIRMATION','').strip()
COLECTIVOS_PRODUCTION_RISK_WRITE_CONFIRMATION=os.getenv('COLECTIVOS_PRODUCTION_RISK_WRITE_CONFIRMATION','').strip()
COLECTIVOS_RISK_PUBLISH_ENABLED=env_bool('COLECTIVOS_RISK_PUBLISH_ENABLED',False)
COLECTIVOS_RISK_WRITE_CONFIRMATION=os.getenv('COLECTIVOS_RISK_WRITE_CONFIRMATION','').strip()
COLECTIVOS_SANDBOX_SUBRISK_WRITE_CONFIRMATION=os.getenv('COLECTIVOS_SANDBOX_SUBRISK_WRITE_CONFIRMATION','').strip()
COLECTIVOS_PRODUCTION_SUBRISK_WRITE_CONFIRMATION=os.getenv('COLECTIVOS_PRODUCTION_SUBRISK_WRITE_CONFIRMATION','').strip()
COLECTIVOS_SUBRISK_PUBLISH_ENABLED=env_bool('COLECTIVOS_SUBRISK_PUBLISH_ENABLED',False)
COLECTIVOS_SUBRISK_WRITE_CONFIRMATION=os.getenv('COLECTIVOS_SUBRISK_WRITE_CONFIRMATION','').strip()
COLECTIVOS_MOBILITY_CONTACT_SEED_ENABLED=env_bool('COLECTIVOS_MOBILITY_CONTACT_SEED_ENABLED',False)
COLECTIVOS_MOBILITY_CONTACT_SEED_CONFIRMATION=os.getenv('COLECTIVOS_MOBILITY_CONTACT_SEED_CONFIRMATION','').strip()
COLECTIVOS_MOBILITY_RISK_SEED_ENABLED=env_bool('COLECTIVOS_MOBILITY_RISK_SEED_ENABLED',False)
COLECTIVOS_MOBILITY_RISK_SEED_CONFIRMATION=os.getenv('COLECTIVOS_MOBILITY_RISK_SEED_CONFIRMATION','').strip()
COLECTIVOS_MOBILITY_SUBRISK_SEED_ENABLED=env_bool('COLECTIVOS_MOBILITY_SUBRISK_SEED_ENABLED',False)
COLECTIVOS_MOBILITY_SUBRISK_SEED_CONFIRMATION=os.getenv('COLECTIVOS_MOBILITY_SUBRISK_SEED_CONFIRMATION','').strip()
...
COLECTIVOS_NOVELTY_RESPONSE_ALERT_EMAIL=os.getenv('COLECTIVOS_NOVELTY_RESPONSE_ALERT_EMAIL','').strip()
...
COLECTIVOS_ATTACHMENT_PUBLISH_ENABLED=env_bool('COLECTIVOS_ATTACHMENT_PUBLISH_ENABLED',False)
COLECTIVOS_ATTACHMENT_WRITE_CONFIRMATION=os.getenv('COLECTIVOS_ATTACHMENT_WRITE_CONFIRMATION','').strip()
COLECTIVOS_INVITATION_ATTACHMENT_PUBLISH_ENABLED=env_bool('COLECTIVOS_INVITATION_ATTACHMENT_PUBLISH_ENABLED',False)
COLECTIVOS_SANDBOX_ATTACHMENT_WRITE_CONFIRMATION=os.getenv('COLECTIVOS_SANDBOX_ATTACHMENT_WRITE_CONFIRMATION','').strip()
COLECTIVOS_PRODUCTION_ATTACHMENT_WRITE_CONFIRMATION=os.getenv('COLECTIVOS_PRODUCTION_ATTACHMENT_WRITE_CONFIRMATION','').strip()
...
COLECTIVOS_RENEWAL_WINDOW_DAYS=email_env_int('COLECTIVOS_RENEWAL_WINDOW_DAYS',30,1,90)
COLECTIVOS_RENEWAL_ALERT_DAYS=email_env_int('COLECTIVOS_RENEWAL_ALERT_DAYS',10,1,30)
COLECTIVOS_RENEWAL_BATCH_LIMIT=email_env_int('COLECTIVOS_RENEWAL_BATCH_LIMIT',100,1,1000)
COLECTIVOS_RENEWAL_READ_CACHE_SECONDS=email_env_int('COLECTIVOS_RENEWAL_READ_CACHE_SECONDS',60,10,900)
COLECTIVOS_RENEWAL_LINK_TTL_DAYS=email_env_int('COLECTIVOS_RENEWAL_LINK_TTL_DAYS',8,1,30)
COLECTIVOS_RENEWAL_REMINDER_DAYS=email_env_int('COLECTIVOS_RENEWAL_REMINDER_DAYS',3,1,30)
COLECTIVOS_RENEWAL_EMAIL_HOST=os.getenv('COLECTIVOS_RENEWAL_EMAIL_HOST','smtp.office365.com').strip()
COLECTIVOS_RENEWAL_EMAIL_PORT=email_env_int('COLECTIVOS_RENEWAL_EMAIL_PORT',587,1,65535)
COLECTIVOS_RENEWAL_EMAIL_USE_TLS=env_bool('COLECTIVOS_RENEWAL_EMAIL_USE_TLS',True)
COLECTIVOS_RENEWAL_EMAIL_USER=os.getenv('COLECTIVOS_RENEWAL_EMAIL_USER','gestionbeneficios@segurosays.com').strip()
COLECTIVOS_RENEWAL_EMAIL_PASSWORD=os.getenv('COLECTIVOS_RENEWAL_EMAIL_PASSWORD','')
COLECTIVOS_RENEWAL_EMAIL_FROM=os.getenv('COLECTIVOS_RENEWAL_EMAIL_FROM','gestionbeneficios@segurosays.com').strip()
COLECTIVOS_RENEWAL_INTERNAL_ALERT_EMAIL=os.getenv('COLECTIVOS_RENEWAL_INTERNAL_ALERT_EMAIL','').strip()
...
ZOHO_SANDBOX_WRITE_ENABLED=env_bool('ZOHO_SANDBOX_WRITE_ENABLED',False)
