...
from cotizacion_colectivos.fonconstruimos_discovery import FonconstruimosInsuredResolution


class Command(BaseCommand):
    help = "Resuelve de forma sanitizada Riesgos1.Asegurado hacia Contacts en Sandbox."
    ...
    def handle(self, *args, **options):
        ...
        try:
            result = FonconstruimosInsuredResolution(get_zoho(profile="sandbox")).discover()
