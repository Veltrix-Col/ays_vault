...
- Póliza autorizada: `083002914855`.
- Perfil: `production`; backend: `sdk`; solo lectura.
- Layout: configured; ramo: VG deudores; aseguradora: Seguros de Vida Suramericana S.A.
...
- Procesados: **200** (parcial).
- Estados agregados: {'Activo': 200}.
- Con riesgo relacionado: 0.
- Contactos relacionados verificados: 198.

| Label | API name | Tipo | Poblado | Cobertura | Cliente ve | Cliente edita | A&S edita | Origen |
|---|---|---|---:|---:|---|---|---|---|
| Subriesgo | `Name` | text | 200 | 100.0% | enmascarado | no | sí | Zoho/A&S |
| Asegurado Propietario | `Owner` | ownerlookup | 200 | 100.0% | sí | no | sí | A&S |
| Creado por | `Created_By` | ownerlookup | 200 | 100.0% | sí | no | no | Sistema |
| Modificado por | `Modified_By` | ownerlookup | 200 | 100.0% | sí | no | no | Sistema |
| Hora de creación | `Created_Time` | datetime | 200 | 100.0% | sí | no | no | Sistema |
| Hora de modificación | `Modified_Time` | datetime | 200 | 100.0% | sí | no | no | Sistema |
| Moneda | `Currency` | picklist | 200 | 100.0% | sí | no | sí | Zoho/A&S |
| Tasa de cambio | `Exchange_Rate` | double | 200 | 100.0% | sí | no | no | Sistema |
| ID de registro | `id` | bigint | 200 | 100.0% | sí | no | no | Sistema |
| Locked | `Locked__s` | boolean | 200 | 100.0% | sí | no | no | Sistema |
| Afiliado | `Contacto_facturaci_n_dividida_colectivas` | lookup | 200 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Pago EMPRESA (Sin IVA) | `Prima` | currency | 200 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Póliza | `P_liza` | lookup | 200 | 100.0% | sí | no | sí | Zoho/A&S |
| Asegurado | `Asegurado` | lookup | 200 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Estado asegurado | `Estado` | picklist | 200 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Valor asegurado | `Valor_asegurado` | currency | 200 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Key asegurado | `key_riesgo_asignado` | text | 200 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Fecha ingreso | `Fecha_ingreso_riesgo` | date | 200 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| IVA Empresa | `IVA` | formula | 200 | 100.0% | sí | no | no | Sistema |
| Pago total (Con IVA) | `Pago_total` | formula | 200 | 100.0% | sí | no | no | Sistema |
| ¿Agregar otro correo? | `Agregar_otro_correo` | boolean | 200 | 100.0% | enmascarado | no | sí | Zoho/A&S |
| Plan | `Plan` | text | 200 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Actualizar Key | `Actualizar_Key` | boolean | 200 | 100.0% | sí | no | sí | Zoho/A&S |
| Record Status | `Record_Status__s` | picklist | 200 | 100.0% | sí | no | sí | Zoho/A&S |
| Asistencia | `Asistencia` | boolean | 200 | 100.0% | sí | no | sí | Zoho/A&S |
| Correo electrónico afiliado | `Correo_electr_nico_afiliado` | email | 185 | 92.5% | enmascarado | no | sí | Zoho/A&S |
| Parentesco | `Parentesco` | picklist | 200 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Pago ASEGURADO (Sin IVA) | `Pago_EMPLEADO_Sin_IVA` | currency | 200 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Aseguradora | `Aseguradora` | text | 200 | 100.0% | sí | no | no | Sistema |
| Tomador | `Tomador` | text | 200 | 100.0% | sí | no | no | Sistema |
| IVA Asegurado | `IVA_Empleado` | formula | 200 | 100.0% | sí | no | no | Sistema |
| Ramo | `Ramo` | picklist | 200 | 100.0% | sí | no | sí | Zoho/A&S |
| % IVA | `IVA1` | formula | 200 | 100.0% | sí | no | no | Sistema |
| Validación prima anterior | `Validaci_n_prima_anterior` | formula | 200 | 100.0% | sí | no | no | Sistema |
| Asegurado con Gestor Asignado | `Asegurado_con_Gestor_Asignado` | boolean | 200 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Endoso | `Endoso` | boolean | 200 | 100.0% | sí | no | sí | Zoho/A&S |
| Valor asegurado total | `Valor_asegurado_total` | formula | 200 | 100.0% | sí | no | no | Sistema |
