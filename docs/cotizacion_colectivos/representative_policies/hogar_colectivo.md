...
- Póliza autorizada: `1000166`.
- Perfil: `production`; backend: `sdk`; solo lectura.
- Layout: configured; ramo: Hogar colectivo; aseguradora: SBS Compañia de Seguros S.A.
...
- Procesados: **8** (completo).
- Estados agregados: {'Activo': 6, 'Excluido': 2}.
- Con riesgo relacionado: 8.
- Contactos relacionados verificados: 7.

| Label | API name | Tipo | Poblado | Cobertura | Cliente ve | Cliente edita | A&S edita | Origen |
|---|---|---|---:|---:|---|---|---|---|
| Subriesgo | `Name` | text | 8 | 100.0% | enmascarado | no | sí | Zoho/A&S |
| Asegurado Propietario | `Owner` | ownerlookup | 8 | 100.0% | sí | no | sí | A&S |
| Correo electrónico | `Email` | email | 8 | 100.0% | enmascarado | no | sí | Zoho/A&S |
| Creado por | `Created_By` | ownerlookup | 8 | 100.0% | sí | no | no | Sistema |
| Modificado por | `Modified_By` | ownerlookup | 8 | 100.0% | sí | no | no | Sistema |
| Hora de creación | `Created_Time` | datetime | 8 | 100.0% | sí | no | no | Sistema |
| Hora de modificación | `Modified_Time` | datetime | 8 | 100.0% | sí | no | no | Sistema |
| Hora de la última actividad | `Last_Activity_Time` | datetime | 8 | 100.0% | sí | no | no | Sistema |
| Moneda | `Currency` | picklist | 8 | 100.0% | sí | no | sí | Zoho/A&S |
| Tasa de cambio | `Exchange_Rate` | double | 8 | 100.0% | sí | no | no | Sistema |
| ID de registro | `id` | bigint | 8 | 100.0% | sí | no | no | Sistema |
| Locked | `Locked__s` | boolean | 8 | 100.0% | sí | no | no | Sistema |
| Correo electrónico beneficiario | `Correo_electr_nico_beneficiario` | email | 8 | 100.0% | enmascarado | pendiente | sí | Cliente/A&S |
| Afiliado | `Contacto_facturaci_n_dividida_colectivas` | lookup | 8 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Pago EMPRESA (Sin IVA) | `Prima` | currency | 8 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Póliza | `P_liza` | lookup | 8 | 100.0% | sí | no | sí | Zoho/A&S |
| Asegurado | `Asegurado` | lookup | 8 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Beneficiario | `Beneficiario` | lookup | 8 | 100.0% | enmascarado | pendiente | sí | Cliente/A&S |
| Estado asegurado | `Estado` | picklist | 8 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Riesgo | `Riesgo` | lookup | 8 | 100.0% | sí | no | sí | Zoho/A&S |
| Valor asegurado | `Valor_asegurado` | currency | 8 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Key asegurado | `key_riesgo_asignado` | text | 8 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Fecha ingreso | `Fecha_ingreso_riesgo` | date | 8 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| IVA Empresa | `IVA` | formula | 8 | 100.0% | sí | no | no | Sistema |
| Pago total (Con IVA) | `Pago_total` | formula | 8 | 100.0% | sí | no | no | Sistema |
| ¿Agregar otro correo? | `Agregar_otro_correo` | boolean | 8 | 100.0% | enmascarado | no | sí | Zoho/A&S |
| Plan | `Plan` | text | 8 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Actualizar Key | `Actualizar_Key` | boolean | 8 | 100.0% | sí | no | sí | Zoho/A&S |
| Record Status | `Record_Status__s` | picklist | 8 | 100.0% | sí | no | sí | Zoho/A&S |
| Tipo de riesgo | `Tipo_de_riesgo` | picklist | 1 | 12.5% | sí | no | sí | Zoho/A&S |
| Valor total asegurado | `Valor_asegurado_total1` | formula | 7 | 87.5% | sí | no | no | Sistema |
| Valor total índice variable | `Valor_ndice_variable_total` | formula | 1 | 12.5% | sí | no | no | Sistema |
| Asistencia | `Asistencia` | boolean | 8 | 100.0% | sí | no | sí | Zoho/A&S |
| Pago total Afiliado (Según la forma de pago) | `Pago_total_Seg_n_la_forma_de_pago_Valor_asegura` | currency | 8 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Correo electrónico afiliado | `Correo_electr_nico_afiliado` | email | 8 | 100.0% | enmascarado | no | sí | Zoho/A&S |
| Pago ASEGURADO (Sin IVA) | `Pago_EMPLEADO_Sin_IVA` | currency | 8 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Aseguradora | `Aseguradora` | text | 8 | 100.0% | sí | no | no | Sistema |
| Tomador | `Tomador` | text | 8 | 100.0% | sí | no | no | Sistema |
| IVA Asegurado | `IVA_Empleado` | formula | 8 | 100.0% | sí | no | no | Sistema |
| Ramo | `Ramo` | picklist | 8 | 100.0% | sí | no | sí | Zoho/A&S |
| % IVA | `IVA1` | formula | 8 | 100.0% | sí | no | no | Sistema |
| Validación prima anterior | `Validaci_n_prima_anterior` | formula | 8 | 100.0% | sí | no | no | Sistema |
| Asegurado con Gestor Asignado | `Asegurado_con_Gestor_Asignado` | boolean | 8 | 100.0% | sí | pendiente | sí | Cliente/A&S |
| Endoso | `Endoso` | boolean | 8 | 100.0% | sí | no | sí | Zoho/A&S |
| Valor asegurado total | `Valor_asegurado_total` | formula | 8 | 100.0% | sí | no | no | Sistema |
| Valor total | `Campo_de_f_rmula_1` | formula | 7 | 87.5% | sí | no | no | Sistema |

## Riesgos

- Riesgos vinculados por `Riesgos1.Riesgo`: **8**.

| Label | API name | Tipo | Poblado | Cobertura | Cliente ve | Cliente edita | A&S edita | Origen |
|---|---|---|---:|---:|---|---|---|---|
| Key Riesgo | `Name` | text | 8 | 100.0% | enmascarado | no | sí | Zoho/A&S |
| Riesgo Propietario | `Owner` | ownerlookup | 8 | 100.0% | sí | no | sí | A&S |
| Creado por | `Created_By` | ownerlookup | 8 | 100.0% | sí | no | no | Sistema |
| Modificado por | `Modified_By` | ownerlookup | 8 | 100.0% | sí | no | no | Sistema |
| Hora de creación | `Created_Time` | datetime | 8 | 100.0% | sí | no | no | Sistema |
| Hora de modificación | `Modified_Time` | datetime | 8 | 100.0% | sí | no | no | Sistema |
...
| Moneda | `Currency` | picklist | 8 | 100.0% | sí | no | sí | Zoho/A&S |
| Tasa de cambio | `Exchange_Rate` | double | 8 | 100.0% | sí | no | no | Sistema |
| Diseño | `Layout` | layout | 8 | 100.0% | sí | no | no | Sistema |
| ID de registro | `id` | bigint | 8 | 100.0% | sí | no | no | Sistema |
| Año construcción | `A_o_construcci_n` | integer | 7 | 87.5% | sí | no | sí | Zoho/A&S |
| Ciudad | `Ciudad` | picklist | 8 | 100.0% | sí | no | sí | Zoho/A&S |
| Zona | `Zona` | picklist | 8 | 100.0% | sí | no | sí | Zoho/A&S |
| Locked | `Locked__s` | boolean | 8 | 100.0% | sí | no | no | Sistema |
| Placa | `Placa_del_vehiculo` | text | 8 | 100.0% | sí | no | sí | Zoho/A&S |
| Dirección | `Direccion` | text | 8 | 100.0% | enmascarado | no | sí | Zoho/A&S |
| Key Riesgo Vehiculo | `Key_Riesgo_Vehiculo` | formula | 8 | 100.0% | sí | no | no | Sistema |
| Key riesgo inmueble | `Key_riesgo_inmueble` | formula | 8 | 100.0% | sí | no | no | Sistema |
| Edad | `Edad` | formula | 8 | 100.0% | sí | no | no | Sistema |
| Campaña de renovación | `Enviar_correo_de_renovaci_n_Oportunidad` | picklist | 8 | 100.0% | enmascarado | no | sí | Zoho/A&S |
| Record Status | `Record_Status__s` | picklist | 8 | 100.0% | sí | no | sí | Zoho/A&S |
| Año construcción PIGT | `A_o_construcci_n_PIGT` | picklist | 7 | 87.5% | sí | no | sí | Zoho/A&S |
| Tipo de riesgo | `Tipo_de_riesgo` | picklist | 8 | 100.0% | sí | no | sí | Zoho/A&S |
| Tipo de uso | `Tipo_de_uso` | picklist | 5 | 62.5% | sí | no | sí | Zoho/A&S |
| Urbanización o Edificio | `Urbanizacion` | text | 2 | 25.0% | sí | no | sí | Zoho/A&S |
| Apartamento - Casa - Lote | `Apartamento_o_casa` | text | 5 | 62.5% | sí | no | sí | Zoho/A&S |
| Nombre anterior | `Nombre_anterior` | text | 8 | 100.0% | enmascarado | no | sí | Zoho/A&S |
| Verificado | `Verificado` | boolean | 8 | 100.0% | sí | no | sí | Zoho/A&S |
| Sin número de contrato | `Sin_n_mero_de_contrato` | boolean | 8 | 100.0% | sí | no | sí | Zoho/A&S |
